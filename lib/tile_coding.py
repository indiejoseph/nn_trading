...
class TileCoder:
  ...
  """
  def __init__(self, n_input, n_output, n_tiles, scale=None, table_size=2048, random_seed=None):
    """
    ...
    self.hfunc = SimpleHash(self.table_size, self.n_tiles, self.random_seed)
...
if __name__ == '__main__':
  tc = TileCoder(4, 4, 2, scale=None, table_size=2048, random_seed=123)
  print tc(np.array([12, 32, -154, 34]))
